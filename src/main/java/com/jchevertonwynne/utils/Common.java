...
public class Common {
    ...
    public static final Coord START_POSITION = new Coord(450, 700);
    ...
    public static final int DFS_MAX_TURNS_WITHOUT_FIND = 200;

    public static final boolean RANDOM_SELECTION = false;
    public static final int RANDOM_BEST_SELECT_LIMIT = 15;
}
